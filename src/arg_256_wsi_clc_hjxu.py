...
caffe_root = '/home/hjxu/git/caffe/' # 需要修改成caffe的路径
import sys
...
one wsi classify
'''
WSI = "/home/hjxu_disk/oral/data/JHU16.tiff"  # 需要跑的图像的路径
path_of_heat_to_save = "/home/hjxu_disk/oral/pred/evaluatation/Pred2/JHU_16_ooo.jpg"  # 结果需要保存的路径,每跑一张图就需要修改

#==================
'''
batch classify wsi
'''
TUMOR_WSI_PATH = "/home/hjxu_disk/oral/data/"
HEAT_MAP_SAVE_PATH = "/home/hjxu_disk/oral/p/"
